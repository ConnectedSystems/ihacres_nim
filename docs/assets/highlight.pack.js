...
relevance:0},a,c]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
},{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,c,t]}]}}})());hljs.registerLanguage("nim",(()=>{"use strict";return e=>({name:"Nim",keywords:{
...
begin:/\b(\d[_\d]*)('?[iIuUfF](8|16|32|64))?/}]},e.HASH_COMMENT_MODE]})})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
begin:s+n+"$"}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
